...
def save_note_to_db(note_text):
    try:
        ...
        notification.notify(
            title="Note Saved",
            message="Note has been saved to database and emailed.",
            timeout=4
        )
...
tk.Label(battery_widgets, text="Estimated Time Left", font=("Arial", 12), bg="#f0f0f0").pack(pady=(10, 0))
...
# TEMP
temp_img = Image.open(r"C:\\Users\\chanm\\OneDrive\\Desktop\\tkinterproject\\image\\icons8-manpower-48.png")
...
# %TEMP%
percent_temp_img = Image.open(r"C:\\Users\\chanm\\OneDrive\\Desktop\\tkinterproject\\image\\icons8-temp-48.png")
...
# Prefetch
prefetch_img = Image.open(r"C:\\Users\\chanm\\OneDrive\\Desktop\\tkinterproject\\image\\icons8-cleaning-service-48.png")
